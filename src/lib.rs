...
//quad to fill the entire screen
#[rustfmt::skip]
const VERTICES: &[Vertex] = &[
    Vertex { position: [-1.0, 1.0, 1.0], tex_coords: [0.0, 0.0]}, // 0
    Vertex { position: [-1.0, -1.0, 1.0], tex_coords: [0.0, 1.0]}, // 1
    Vertex { position: [1.0, -1.0, 1.0], tex_coords: [1.0, 1.0]}, // 2
    Vertex { position: [1.0, 1.0, 1.0], tex_coords: [1.0, 0.0]}, // 3
...
impl State {
    ...
    fn resize(&mut self, new_size: winit::dpi::PhysicalSize<u32>) {
        if new_size.width > 0 && new_size.height > 0 {
            ...
            self.data_uniform.screen_size = new_size.into();
        }
    }
    ...
    fn update(&mut self) {
        self.data_uniform.time = self.start_time.elapsed().as_secs_f32();
